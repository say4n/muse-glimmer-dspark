...
class MuseGlimmerDSparkEvaluator(Qwen3DSparkEvaluator):
    draft_model_cls = MuseGlimmerDSparkModel

    def build_models(self) -> tuple[object, MuseGlimmerDSparkModel, AutoTokenizer]:
